  ...
  return (
    <PageShell>
      ...
      <section className="py-20 px-6 relative overflow-hidden">
        ...
        <div className="absolute inset-0" style={{ zIndex: -10, background: 'linear-gradient(155deg, rgba(132,31,137,0.58), rgba(74,15,92,0.55))' }} />
        <div className="absolute inset-0 pointer-events-none" style={{ zIndex: -5, background: 'radial-gradient(600px 460px at 92% 0%, rgba(232,7,139,0.3), transparent 70%), radial-gradient(500px 400px at 4% 100%, rgba(245,176,21,0.16), transparent 70%)' }} />
        <div className="max-w-[1240px] mx-auto relative">
          <div className="max-w-[680px] mb-14">
            <span
              className="inline-flex items-center gap-2 text-[14px] font-semibold tracking-[0.14em] uppercase text-[#ffcdec] mb-3"
              style={{ textShadow: '0 2px 10px rgba(0,0,0,0.55)' }}
            >
              <span className="w-5 h-[2px] bg-[#ffcdec] rounded-full" />
              ¿Qué ofrecemos?
            </span>
            <h2
              className="text-[clamp(32px,3.8vw,48px)] font-bold tracking-[-0.025em] text-white mb-3"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {OFFER.map((f, i) => (
              ...
              >
                <div
                  className="w-16 h-16 rounded-[12px] grid place-items-center mb-4"
                  style={{ background: `${f.color}18`, color: f.color }}
                >
                  {f.icon}
                </div>
                <h3 className="text-[18px] font-bold text-[#0a1133] mb-2">{f.title}</h3>
                <p className="text-[15px] text-[#6a7196] leading-relaxed">{f.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-6 relative overflow-hidden">
        ...
        <div className="absolute inset-0" style={{ zIndex: -10, background: 'linear-gradient(155deg, rgba(10,17,51,0.55), rgba(13,30,107,0.5))' }} />
        <div className="absolute inset-0 pointer-events-none" style={{ zIndex: -5, background: 'radial-gradient(600px 460px at 95% 100%, rgba(232,7,139,0.2), transparent 70%), radial-gradient(500px 400px at 0% 0%, rgba(245,176,21,0.14), transparent 70%)' }} />
        <div className="max-w-[1240px] mx-auto relative">
          <div className="max-w-[680px] mb-14">
            <span
              className="inline-flex items-center gap-2 text-[14px] font-semibold tracking-[0.14em] uppercase text-[#ff9fd9] mb-3"
              style={{ textShadow: '0 2px 10px rgba(0,0,0,0.6)' }}
            >
              <span className="w-5 h-[2px] bg-[#ff9fd9] rounded-full" />
              Por qué MIC
            </span>
            <h2
              className="text-[clamp(32px,3.8vw,48px)] font-bold tracking-[-0.025em] text-white mb-3"
            ...
            {WHY.map((item, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>
                  </span>
                  <span className="text-[17px] font-semibold text-white" style={{ textShadow: '0 1px 6px rgba(0,0,0,0.5)' }}>{item}</span>
                </motion.div>
              );
            })}
          </div>
