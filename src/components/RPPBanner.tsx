...
const BANNERS = [
  ...
  { src: '/RPP-MIC.png',             alt: 'MIC — Distribuidor Oficial de RPP TV en Perú' },
  ...
  return (
    <section className="pt-[72px] bg-[#0a1133]">
      <div className="relative overflow-hidden">
        ...
        <Link
          href="/catalogo"
          className="group absolute left-6 bottom-24 z-10 inline-flex items-center gap-2.5 px-8 py-[18px] bg-[#E8078B] text-white text-[17px] font-bold rounded-[14px] ring-2 ring-white/70 shadow-[0_10px_30px_rgba(232,7,139,0.6)] hover:bg-[#ff1e9f] hover:scale-105 hover:shadow-[0_14px_38px_rgba(232,7,139,0.7)] transition-all duration-200"
        >
          Ver catálogo
